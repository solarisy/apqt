				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>个人档案<i class="icon-angle-right"></i></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>个人档案</div>
							...
							<div class="portlet-body form">
								...
								<form action="${ctx}/profile" id="inputForm" class="form-horizontal" method="post">
