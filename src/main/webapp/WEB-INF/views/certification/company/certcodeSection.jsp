					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="${ctx}/cert/company/certcode/save" id="inputForm" class="form-horizontal" method="post">
									<input type="hidden" name="id" value="${company.id}"/>
									<div class="control-group">
										<label class="control-label">公司名称<span class="required">*</span></label>
										<div class="controls">
											<input type="text" value="${company.nameCn}" disabled id="nameCn" data-required="1" class="span6 m-wrap"/>
										</div>
