...
<div class="m-mianWap clearfix auto">
  <div class=" width1000 auto clearfix">
    ...
    <p class="font20 top50 colblue center">个人信息查询</p>
      ...
      <div class="pad20">
        <div class="m-tab">
          ...
          <div class="cont" style="padding:40px 20px 0 20px;">
          	 <form action="${ctx}/web/search/personal" id="inputForm1" method="get" class="form-search">
          ...
          <div class="cont" style="padding:40px 20px 0 20px; display:none">
          	 <form action="${ctx}/web/search/personal" id="inputForm2" method="get" class="form-search">
          	    <input type="hidden" name="searchBy" value="idNumber"/>
	            <input type="text" value="${personal.idNumber}" name="idNumber"  id="idNumber" style="width:400px;" class="verMid" placeholder="请输入身份证号码"/>
	      ...
	      <div class="cont" style="padding:40px 20px 0 20px; display:none">
         	 <form action="${ctx}/web/search/personal" id="inputForm3" method="get" class="form-search">
         	    <input type="hidden" name="searchBy" value="name"/>
	            <input type="text" value="${personal.name}" name="name" id="name" style="width:400px;" class="verMid"  placeholder="请输入姓名"/>
