...
<div class="m-mianWap clearfix auto">
  <div class=" width1000 auto clearfix">
    ...
    <p class="font20 top50 colblue center">公司信息查询</p>
      ...
      <div class="pad20">
        <div class="m-tab">
          ...
          <div class="cont" style="padding:40px 20px 0 20px;">
            <form action="${ctx}/web/search/company" id="inputForm1" method="get" class="form-search">
               <input type="hidden" name="searchBy" value="certcode"/>
               <input type="text" value="${company.certcode}" name="certcode" id="certcode" style="width:400px;" class="verMid" placeholder="请输入公司诚信信用码" />
          ...
          <div class="cont" style="padding:40px 20px 0 20px; display:none">
          	 <form action="${ctx}/web/search/company" id="inputForm2" method="get" class="form-search">
          	    <input type="hidden" name="searchBy" value="orgcode"/>
	            <input type="text" value="${company.orgcode}" name="orgcode"  id="orgcode" style="width:400px;" class="verMid" placeholder="请输入组织机构代码"/>
	      ...
	      <div class="cont" style="padding:40px 20px 0 20px; display:none">
         	 <form action="${ctx}/web/search/company" id="inputForm3" method="get" class="form-search">
         	    <input type="hidden" name="searchBy" value="nameCn"/>
	            <input type="text" value="${company.nameCn}" name="nameCn" id="nameCn" style="width:400px;" class="verMid"  placeholder="请输入公司名称"/>
...
$(function(){
	...
	if(searchBy=="certcode"){
		changeTab(0);
		$("#msg1").text("诚信信用码错误");
	}else if(searchBy=="orgcode"){
		changeTab(1);
		$("#msg2").text("组织机构代码码错误");
	}else if(searchBy=="nameCn"){
		changeTab(2);
		$("#msg3").text("公司名称错误");
	}
