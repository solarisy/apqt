					...
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="${ctx}/proxy/certcode/save" id="inputForm" class="form-horizontal" method="post">
									<input type="hidden" name="id" value="${proxy.id}"/>
									<div class="control-group">
										<label class="control-label">代理名称<span class="required">*</span></label>
										<div class="controls">
											<input type="text" value="${proxy.nameCn}" disabled id="nameCn" data-required="1" class="span6 m-wrap"/>
										</div>
